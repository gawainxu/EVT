...
if __name__ == '__main__':
    ...
    testDataFolder = '/home/zhi/projects/faultDiagnosis/paderborn/class13_0_12_4'
    testDT = ImageTSDataset(testDataFolder)
    
    testDTLoader = DataLoader(testDT, batch_size=1 , shuffle=True, drop_last=True)
    device = 'cpu'
    
    modelPath = '/home/zhi/projects/faultDiagnosis/paderborn/LossFiles/LeNet_enhanced2_class13_4.pt'
    ...
    # read the outputs
    outputSorted = [[] for _ in range(numClasses)]      # 1 for the outlier !!!
    predictSorted = [[] for _ in range(numClasses)]
    ...
    with open('/home/zhi/projects/EVT/paderborn/FeatureMaps/class13_0_12_4_outputs', "wb") as f1:
        pickle.dump(outputSorted, f1)
        
    with open('/home/zhi/projects/EVT/paderborn/FeatureMaps/class13_0_12_4_predicts', "wb") as f2:
